...
urlpatterns = [
    ...
    path('documentos/<int:pk>/', views.detalhe_documento, name='detalhe_documento'), # Usando pk
    ...
    # Removi relatorio_detail pois o download_relatorio já usa o PK.
    # Se precisar de uma página de detalhes do relatório que não seja o download, crie uma view separada.
